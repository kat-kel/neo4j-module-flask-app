...
def create_app(test_config=None):
    ...
    # JWT
    # Routes that use the Flask-JWT-Extended extension's 'current_user' function and/or
    # have the extension's @jwt_required decorator will not work without registering
    # the app with JWTManager.
    _ = JWTManager(app)
